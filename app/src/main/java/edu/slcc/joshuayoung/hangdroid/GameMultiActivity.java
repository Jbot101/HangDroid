...
public class GameMultiActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String wordToGuess = "";
        wordToGuess = getIntent().getStringExtra("GUESS_WORD");//defaults if data does not
    ...
    private void createTextViews(String wordToGuess) {
        //get layout
        LinearLayout layout = (LinearLayout) findViewById(R.id.LayoutLetters);

        //create on textview in xml and copy to the others
    ...
    //receives the users letter guess and checks if the letter given exists
    public void checkLetter(String letter){
        ...
        //letter was not found in word. Add to wrong list of letters
        if(!letterGuessed) {
    ...
    public void wrongLetter(String badLetter) {
        ...
        //make a reference to imageview in activity_game.xml
